...
struct IsFirst_Previews: PreviewProvider {
    static var previews: some View {
        IsFirst(locationManager: LocationManager.shared, tm: TemplateManager.shared, weatherViewModel: WeatherViewModel.shared, mediaItemViewModel: MediaItemViewModel.shared)
    }
}
